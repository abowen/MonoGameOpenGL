...
namespace MonoGame.Game.Twitch.Screens
{
    public class StartScreen : GameLevel
    {
        ...
        protected override void LoadDisplay()
        {
            ...
            var textSimpleRpg = new TextComponent(font, "TWITCH", new Vector2(-75, -25), 2);
            ...
            var sword = new SpriteMappingComponent(RpgGraphics.GameboySpriteMapping, "Sword7", new Vector2(200, 0), 3f);
